...
{{-- Menggunakan layout utama dari folder layouts --}}

@section('content')
<div class="mt-20 max-w-3xl mx-auto">

    {{-- ============================= --}}
    {{-- SECTION: Kartu Profil & Info --}}
    {{-- ============================= --}}

    <div class="rounded-2xl pb-2 pt-7">
        <!-- Profil Card -->
    ...
    {{-- Spasi antar elemen profil dan menu --}}
    <div class="mt-5"></div>
    ...
    <div class="bg-white rounded-xl p-4 shadow-lg mx-2 mt-4 mb-8 pb-4">
        <div class="space-y-3">
            ...
            {{-- Menu: MyFlyTrip Info --}}
            <a href="#"
               class="w-full text-left border-b border-gray-400 pb-3 flex flex-col hover:bg-gray-300 p-2 rounded-md transition">
            ...
            {{-- Menu: Logout (gunakan form POST karena aksi yang mengubah state/login) --}}
    ...
    {{-- Spacer sebelum footer/navigation bawah --}}
    <div class="h-10"></div>
</div>
@endsection
